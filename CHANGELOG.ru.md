...
- **Fix** и **Smart Fix** отсутствующего типа в сохранённом ассете в инспекторе UI Toolkit больше не выводят исключение; поля ссылок в других инспекторах обновляются сразу после ремонта.
