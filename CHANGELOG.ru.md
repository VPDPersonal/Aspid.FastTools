...
- Восстановление потерянного типа больше не отбрасывает молча несохранённые изменения восстанавливаемого ассета. **Fix** и **Smart Fix** в инспекторе восстанавливают такой ассет в памяти, **Fix all**, **Clear** и **Undo** в Project References пропускают его или очищают в памяти, а восстановление и очистка в Asset References предлагают сначала его сохранить. **Fix** в инспекторе больше не переписывает префаб, открытый в Prefab Mode.
