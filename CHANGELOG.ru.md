...
- Сохранённый шаблон, тип которого сейчас не находится (класс переименован, другая ветка, пакет удалён), теперь только скрывается из **Paste Template**. Раньше открытие контекстного меню удаляло его навсегда, во всех копиях проекта.
