...
**Unity Fast Tools** — набор инструментов, предназначенных для минимизации рутинного написания кода в Unity.

## Исходный код

[[Aspid.UnityFastTools](https://github.com/VPDPersonal/Aspid.UnityFastTools)]
...
```
![Aspid.UnityFastTools.SerializableType.png](Images/Aspid.UnityFastTools.SerializableType.png)
...
![Aspid.UnityFastTools.TypeSelectorWindow.png](Images/Aspid.UnityFastTools.TypeSelectorWindow.png)
---
