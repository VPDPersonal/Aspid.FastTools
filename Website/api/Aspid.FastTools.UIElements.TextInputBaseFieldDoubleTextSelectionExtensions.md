---
title: "Class TextInputBaseFieldDoubleTextSelectionExtensions"
sidebar_label: "TextInputBaseFieldDoubleTextSelectionExtensions"
description: "Class TextInputBaseFieldDoubleTextSelectionExtensions — Aspid.FastTools API reference"
hide_title: true
pagination_prev: null
pagination_next: null
---
# Class TextInputBaseFieldDoubleTextSelectionExtensions {#Aspid_FastTools_UIElements_TextInputBaseFieldDoubleTextSelectionExtensions}

Namespace: [Aspid.FastTools.UIElements](Aspid.FastTools.UIElements.md)  
Assembly: Aspid.FastTools.dll  

Provides text-selection extension methods for [`TextInputBaseField<T>`](https://docs.unity3d.com/ScriptReference/UIElements-TextInputBaseField.html) of [`Double`](https://learn.microsoft.com/dotnet/api/system.double).

```csharp
public static class TextInputBaseFieldDoubleTextSelectionExtensions
```
...
```csharp
public static T AddOnCursorIndexChange<T>(this T element, Action value) where T : TextInputBaseField<double>
```
...
```csharp
public static T AddOnSelectIndexChange<T>(this T element, Action value) where T : TextInputBaseField<double>
```
...
```csharp
public static T RemoveOnCursorIndexChange<T>(this T element, Action value) where T : TextInputBaseField<double>
```
...
```csharp
public static T RemoveOnSelectIndexChange<T>(this T element, Action value) where T : TextInputBaseField<double>
```
...
```csharp
public static T SetCursorIndex<T>(this T element, int value) where T : TextInputBaseField<double>
```
...
### SetDoubleClickSelectsWord\<T\>\(T, bool\) {#Aspid_FastTools_UIElements_TextInputBaseFieldDoubleTextSelectionExtensions_SetDoubleClickSelectsWord__1___0_System_Boolean_}
...
```csharp
public static T SetDoubleClickSelectsWord<T>(this T element, bool value) where T : TextInputBaseField<double>
```
...
### SetSelectAllOnFocus\<T\>\(T, bool\) {#Aspid_FastTools_UIElements_TextInputBaseFieldDoubleTextSelectionExtensions_SetSelectAllOnFocus__1___0_System_Boolean_}

Sets [`selectAllOnFocus`](https://docs.unity3d.com/ScriptReference/UIElements-TextInputBaseField-selectAllOnFocus.html).

```csharp
public static T SetSelectAllOnFocus<T>(this T element, bool value) where T : TextInputBaseField<double>
```
...
### SetSelectAllOnMouseUp\<T\>\(T, bool\) {#Aspid_FastTools_UIElements_TextInputBaseFieldDoubleTextSelectionExtensions_SetSelectAllOnMouseUp__1___0_System_Boolean_}

Sets [`selectAllOnMouseUp`](https://docs.unity3d.com/ScriptReference/UIElements-TextInputBaseField-selectAllOnMouseUp.html).

```csharp
public static T SetSelectAllOnMouseUp<T>(this T element, bool value) where T : TextInputBaseField<double>
```
...
### SetSelectIndex\<T\>\(T, int\) {#Aspid_FastTools_UIElements_TextInputBaseFieldDoubleTextSelectionExtensions_SetSelectIndex__1___0_System_Int32_}

Sets [`selectIndex`](https://docs.unity3d.com/ScriptReference/UIElements-TextInputBaseField-selectIndex.html).

```csharp
public static T SetSelectIndex<T>(this T element, int value) where T : TextInputBaseField<double>
```
...
### SetSelectable\<T\>\(T, bool\) {#Aspid_FastTools_UIElements_TextInputBaseFieldDoubleTextSelectionExtensions_SetSelectable__1___0_System_Boolean_}
...
```csharp
public static T SetSelectable<T>(this T element, bool value) where T : TextInputBaseField<double>
```
...
### SetTripleClickSelectsLine\<T\>\(T, bool\) {#Aspid_FastTools_UIElements_TextInputBaseFieldDoubleTextSelectionExtensions_SetTripleClickSelectsLine__1___0_System_Boolean_}
...
```csharp
public static T SetTripleClickSelectsLine<T>(this T element, bool value) where T : TextInputBaseField<double>
```
