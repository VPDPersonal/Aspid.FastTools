...
- **Fix** and **Smart Fix** of a missing type on a saved asset in a UI Toolkit inspector no longer log an exception about a disposed `SerializedObject`; other reference fields now refresh right after the repair.
