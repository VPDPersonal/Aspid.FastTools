...
- A saved template whose type does not resolve at the moment (a renamed class, another branch, a removed package) is now only hidden from **Paste Template**; opening the context menu used to delete it for good, in every copy of the project.
