...
- Repairing a missing type no longer silently discards unsaved changes of the asset being repaired. **Fix** and **Smart Fix** in the Inspector repair such an asset in memory, **Fix all**, **Clear** and **Undo** in Project References skip it or clear it in memory, and repairs and clears in Asset References offer to save it first. **Fix** in the Inspector no longer rewrites a prefab asset that is open in Prefab Mode.
