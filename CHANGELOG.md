...
- **Nested references keep their prefab overrides actionable.** Drawn outside Unity's binding, a nested row showed no overridden-value treatment and offered no Revert/Apply; both are now applied directly.
