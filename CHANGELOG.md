...
- **+** of a `[TypeSelector]` `[SerializeReference]` list nested in an element of another array (a list of structs, a list inside a list element) now appends to that list; it used to grow the outer array and throw `InvalidOperationException`.
