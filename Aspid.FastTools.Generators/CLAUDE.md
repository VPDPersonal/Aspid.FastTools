...
All generated files begin with `// <auto-generated>` and enable `#nullable enable`.
...
Finds `partial struct` types implementing `Aspid.FastTools.IId` and generates boilerplate: serialized `_id` field, `Id` property, editor-only `__stringId` field, and equality/comparison members.
