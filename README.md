...
public sealed class AbilitySelector : MonoBehaviour
{
    ...
    // [SerializeReference] — picking a type instantiates it into the field;
    // with no arguments the candidates default to the field's declared type.
...
> Full reference: [SerializeReferences.md](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/EN/SerializeReferences.md)
