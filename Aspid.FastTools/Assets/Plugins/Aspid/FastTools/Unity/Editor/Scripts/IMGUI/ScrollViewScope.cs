...
namespace Aspid.FastTools.Editors
{
    ...
    /// <see cref="EditorGUILayout.EndScrollView"/> that exposes the updated <see cref="ScrollPosition"/>.
    /// Use in a <c>using</c> statement to automatically close the scroll view.
    /// Overloads accepting <c>ref Vector2</c> update the caller's variable in place.
    /// </summary>
    public readonly ref struct ScrollViewScope
    {
        ...
        /// <returns>
        /// A new <see cref="ScrollViewScope"/> with the updated <see cref="ScrollPosition"/>.
        /// </returns>
        ...
        /// <summary>
        /// Begins a scroll view with a single <see cref="GUIStyle"/> applied to it.
        /// </summary>
        /// <param name="scrollPosition">The current scroll position.</param>
