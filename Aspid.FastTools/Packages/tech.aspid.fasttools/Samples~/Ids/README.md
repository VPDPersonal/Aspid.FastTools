...
> **New here? Start with [TUTORIAL.md](TUTORIAL.md)** — a guided, step-by-step tour (Lessons 1–4) built around `Scripts/Tutorial/IdsTutorial.cs` and `Scenes/IdsTutorial.unity`. This page is the demo-scene walkthrough; the tutorial teaches the workflow.
