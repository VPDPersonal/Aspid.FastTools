...
> **Впервые здесь? Начните с [TUTORIAL.ru.md](TUTORIAL.ru.md)** ([EN](TUTORIAL.md)) — пошаговый гид (уроки 1–4) вокруг `Scripts/Tutorial/IdsTutorial.cs` и `Scenes/IdsTutorial.unity`. Эта страница — разбор демо-сцены; туториал учит самому процессу.
