...
- Вкладка **Inspect Asset** строит граф всех `[SerializeReference]` сохранённого ассета и чинит любой потерянный узел
  встроенно (любой глубины, на любом дочернем объекте, до которого инспектор иначе не дотянется).
- Вкладка **Project Audit** проходит по всем ассетам в `Assets/` и группирует сломанные ссылки **по сохранённому типу**
