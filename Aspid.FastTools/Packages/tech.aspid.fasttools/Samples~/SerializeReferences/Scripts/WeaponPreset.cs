...
namespace Aspid.FastTools.Samples.SerializeReferences
{
    ...
    // reference is silently dropped to null on load (Unity bug UUM-129100). The "Edit Type" action that rewrites
    ...
    // so the Inspector shows a "Missing type" warning with an "Edit Type" button — set the class back to "Pistol"
