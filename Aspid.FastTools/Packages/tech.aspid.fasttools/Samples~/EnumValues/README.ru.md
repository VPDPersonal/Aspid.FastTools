...
> **Впервые здесь? Начните с [TUTORIAL.ru.md](TUTORIAL.ru.md)** ([EN](TUTORIAL.md)) — пошаговый тур (уроки 1–5) вокруг `Scripts/Tutorial/EnumValuesTutorial.cs` и `Scenes/EnumValuesTutorial.unity`. Эта страница — разбор демо-сцены; туториал учит самому workflow.
