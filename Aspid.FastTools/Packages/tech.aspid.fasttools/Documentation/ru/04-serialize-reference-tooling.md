...
[Селектор в Инспекторе](03-serialize-reference-selector.md) чинит ссылки по одному полю; этот
...
[Чинить ссылки по одной](03-serialize-reference-selector.md#repairing-broken-references) необязательно:
