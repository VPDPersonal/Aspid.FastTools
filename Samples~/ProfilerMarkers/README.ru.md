...
> **Впервые здесь? Начните с [TUTORIAL.ru.md](TUTORIAL.ru.md)** ([EN](TUTORIAL.md)) — пошаговый тур (уроки 1–4) вокруг `Scripts/Tutorial/ProfilerMarkersTutorial.cs` и `Scenes/ProfilerMarkersTutorial.unity`. Эта страница — компактный справочник по трём формам; туториал разбирает каждую форму вызова по шагам.
