...
> **New here? Start with [TUTORIAL.md](TUTORIAL.md)** — a guided, step-by-step tour (Lessons 1–4) built around `Scripts/Tutorial/ProfilerMarkersTutorial.cs` and `Scenes/ProfilerMarkersTutorial.unity`. This page is the compact reference for the three forms; the tutorial walks each call form lesson by lesson.
