...
- **Breakage toast** — когда ссылки заново становятся потерянными после рекомпиляции, всплывающее уведомление и одно предупреждение в Console ведут прямо в окно починки.
