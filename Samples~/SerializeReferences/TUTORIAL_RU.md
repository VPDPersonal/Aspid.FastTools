...
Поскольку вкладка смешивает командные и индивидуальные настройки, каждая строка помечена цветной полоской слева —
зелёная для значений в коммитимом asset'е `ProjectSettings`, синяя для индивидуальных — с легендой в верхней части
вкладки. Закреплённый внизу вкладки футер предлагает **Reset to defaults** отдельно для каждого scope (**Shared** /
**Per-user**); каждая кнопка показывает подтверждение с точным списком восстанавливаемых значений, а сохранённые
списки Favorites / Recent сброс переживают.
