...
```
![Поле SerializableType с выбором типа в Инспекторе](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_serializable_type.gif)
...
![Окно выбора типа](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_type_selector_window.png)

Выбор открытого generic проходит через страницу его аргументов и возвращает сконструированный тип:

![Выбор открытого generic через страницу аргументов](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_type_selector_generic.gif)
...
![ComponentTypeSelector меняет тип компонента в Инспекторе](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_component_type_selector.gif)
...
![Сгенерированные маркеры в окне Unity Profiler](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_profiler_markers.png)
...
```
![EnumValues в Инспекторе](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_enum_values.png)
...
![Выпадающий список выбора ID в Инспекторе](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_id_selector.gif)
...
![Предупреждение о дубликате ID в Инспекторе](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_id_collision.gif)
...
![Инспектор IdRegistry](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_id_registry.png)
...
![Инспектор AbilityConfig, собранный fluent-расширениями](Aspid.FastTools/Packages/tech.aspid.fasttools/Documentation/Images/aspid_fasttools_visual_element.gif)
